...
public class CleanArchDbContext :
    AbpDbContext<CleanArchDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.ApplyConfigurationsFromAssembly(typeof(CleanArchDbContext).Assembly);

        //builder.Entity<YourEntity>(b =>
        //{
        //    b.ToTable(CleanArchConsts.DbTablePrefix + "YourEntities", CleanArchConsts.DbSchema);
